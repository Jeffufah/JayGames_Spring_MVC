...
import com.JayGames.Network_Application.PageLoader;
...
public class PlotFourGame
{
    ...
    public PlotFourGame(PageLoader pageLoader)
    {
        ...
        pageLoader.setMainScene(new Scene(root, 1920, 1080));
        ...
        for (int columnCounter = 0; columnCounter < playingGrid.length; columnCounter++)
        {
            ...
            for (int rowCounter = 0; rowCounter < playingGrid[0].length; rowCounter++)
            {
                ...
                PlayingSlot playingSlot = new PlayingSlot(this, columnOffset, rowOffset, arrowIndicators, playingGrid, resetButton);
     ...
     * @param arrowIndicators An array of type ArrowIndicator that contains the
     * location of each arrowIndicator at each column.
     * @param resetButton An object of type ResetButton that displays text
     * within when the game has ended.
     */
    public void dropChip(String slotId, PlayingSlot[][] playingGrid, ArrowIndicator[] arrowIndicators, ResetButton resetButton)
    {
