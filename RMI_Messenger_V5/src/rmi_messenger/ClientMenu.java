...
public class ClientMenu
{
    ...
    public ClientMenu(PageLoader pageLoader)
    {
            ...
            {                
                Task task = new Task<Void>()
                {
                    ...
                    public Void call() throws InterruptedException
                    {
                        ...
                        Platform.runLater(() -> pageLoader.loadChatRoom(clientNameTextField.getText(), ipAddressTextField.getText(), clientPortTextField.getText()));            
                        return null;
                    }
                };
        ...
        stage.setTitle("RMI Messenger - Client Menu");
