...
public class HostMenu
{
    ...
    public HostMenu(PageLoader pageLoader)
    {
                ...
                if (validatePort(hostPortTextField.getText()))
                {
                    try
                    {
                        ...
                        if (!hostIP.equals(""))
                        {
                            ...
                            String hostResult = connection.buildConnection();
                            
                            System.out.println(hostResult);
                            
                            String hostName = hostNameTextField.getText();
                            
                            pageLoader.constructServer(hostName, hostIP, Integer.parseInt(hostPortTextField.getText()));

                            pageLoader.constructClient(hostName, "localhost", hostPortTextField.getText());
                        }
                        else
                        {
        ...
        stage.setTitle("Plot Four - Host Menu");
