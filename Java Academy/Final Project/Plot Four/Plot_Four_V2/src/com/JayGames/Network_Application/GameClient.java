...
{    
    ...
    protected boolean establishServerConnection()
    {
        try
        {
            ...
            {
                if (pageLoader.getClientMenu() != null)
                {
                ...
                if (pageLoader.getLobbyMenu() != null)
                {
                    pageLoader.getLobbyMenu().setNotificationLabelText("Connect failed!");
                    pageLoader.getLobbyMenu().setErrorLabelText(serverResponse.getResponse());
                }
        ...
        catch (NumberFormatException | NotBoundException | RemoteException ex)
        {
            ...
            if (pageLoader.getLobbyMenu() != null)
            {
                 pageLoader.getLobbyMenu().setErrorLabelText("Connect failed!");
            }
            ...
            if (ex.getMessage().contains("java.net.NoRouteToHostException"))
            {
                ...
                if (pageLoader.getLobbyMenu() != null)
                {
                    pageLoader.getLobbyMenu().setErrorLabelText("Check your internet connection and try again.");
                }
            }
            else
            {
                ...
                if (pageLoader.getLobbyMenu() != null)
                {
                    pageLoader.getLobbyMenu().setErrorLabelText(
                            "Either the host server is no longer available, or "
                                    + "it is not port forwarded.");
                }
