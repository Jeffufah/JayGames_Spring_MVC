...
public class LinkedListWithIterator<T> implements ListWithIteratorInterface<T> 
{
    ...
    public Iterator<T> instantiateIterator()
    {
        return new IteratorForLinkedList((T) this);
    }
    ...
    /**
     * Create a class to implement the ADT iterator.
     */
    private class IteratorForLinkedList implements Iterator<T> 
    {
        private LinkedListWithIterator linkedList;
         ...
         */
        private IteratorForLinkedList(T linkedList) 
        {
            this.linkedList = (LinkedListWithIterator)linkedList;
        ...
        /**
         * Determines the node that follows the current 
         * @return The node that follows the current node.
         */
        public T next() 
        {
            if (hasNext()) 
        ...
        /**
         * Determines that a node follows the current node.
         * @return A boolean determining whether a node follows the current node.
         */
        ...
        /**
         * Removes the node this iterator is pointing to by 
         * passing the linkedList's remove method the value of iteratorIndex.
         */
        public void remove() 
        {
            if (hasNext()) 
            ...
            linkedList.remove(iteratorIndex);
        }
    }
}